...
class QuizActivity : AppCompatActivity() {
    ...
    private val quizQuestions: List<QuizQuestion> = listOf(
        ...
        QuizQuestion(
            ...
            options = listOf("A. cpu", "B. Moniter", "C. UPS", "D. Mouse"),
            correctAnswer = "A. cpu",
            marks = 3,

            ),
        QuizQuestion(
            question = "Which team never won a single match againts INDIA in icc Cricket World cup Tournament",
            options = listOf("A. SriLanka", "B. Pakistan", "C. Australia", "D. England"),
        ...
        QuizQuestion(
            ...
            options = listOf("A. Ganga", "B. Amazone", "C. Nile", "D. The Yangtze"),
            correctAnswer = "C. Nile",
            marks = 3,

            ),
        QuizQuestion(
            question = " Which bank is called bankers Bank of India?\n\n?",
            options = listOf("A. RBI", "B. PNB", "C. SBI", "D. ICICI"),
            correctAnswer = "A. RBI",
            marks = 3,

            ),
        QuizQuestion(
            question = " What it is called if a batter getting out without facing Any ball\n?",
            options = listOf("A. Duck", "B. Out", "C. Golden Duck", "D. Dimond Duck"),
            correctAnswer = "D. Dimond Duck",
            marks = 3,

            ),
        QuizQuestion(
            question = " Which of the following is the capital of Arunachal Pradesh?\n?",
            options = listOf("A. Itanagar", "B. Dispur", "C. Punjab", "D. Imphal"),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nextbtn.setOnClickListener {
            ...
            if (currentQuestionIndex < quizQuestions.size) {
                ...
                setOptionClickListener(option1btn, quizQuestions[currentQuestionIndex].correctAnswer)
                setOptionClickListener(option2btn, quizQuestions[currentQuestionIndex].correctAnswer)
                setOptionClickListener(option3btn, quizQuestions[currentQuestionIndex].correctAnswer)
                setOptionClickListener(option4btn, quizQuestions[currentQuestionIndex].correctAnswer)
            } else {
    ...
    private fun setQuestion(currentQuestionIndex: Int) {



        val currentQuestion = quizQuestions[currentQuestionIndex]
            questionbtn.text = currentQuestion.question
            option1btn.text = currentQuestion.options[0]
            option2btn.text = currentQuestion.options[1]
            option3btn.text = currentQuestion.options[2]
            option4btn.text = currentQuestion.options[3]
        }
    ...
    private fun resetOptionBackgrounds() {
        val optionTextViews = listOf(option1btn, option2btn, option3btn, option4btn)
